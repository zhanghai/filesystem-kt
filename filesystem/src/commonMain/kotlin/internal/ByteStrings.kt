...
@Suppress("NOTHING_TO_INLINE") internal inline fun ByteString.first(): Byte = this[0]

@Suppress("NOTHING_TO_INLINE") internal inline fun ByteString.last(): Byte = this[lastIndex]
